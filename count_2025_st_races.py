...
cursor.execute('''
    ...
    FROM (
        ...
        WHERE r.race_date >= '2025-01-01' AND r.race_date <= '2025-11-12'
        GROUP BY r.id
...
print('=== 2025年1月～11月12日 ST時間状況 ===')
print(f'ST 6/6（完全）: {count_6}レース')
print(f'ST 5/6（補充対象）: {count_5}レース')
print(f'ST <5: {count_less}レース')
