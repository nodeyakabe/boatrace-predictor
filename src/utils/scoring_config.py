...
class ScoringConfig:
    ...
    def load_weights(self) -> Dict[str, float]:
        ...
        return {
            'course_weight': float(config.get('course_weight', 35.0)),
            'racer_weight': float(config.get('racer_weight', 35.0)),
            'motor_weight': float(config.get('motor_weight', 20.0)),
            'kimarite_weight': float(config.get('kimarite_weight', 5.0)),
            'grade_weight': float(config.get('grade_weight', 5.0))
        }
