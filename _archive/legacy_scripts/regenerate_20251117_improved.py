...
def main():
    print("=" * 80, flush=True)
    print("改善版モデルで2025-11-17予測を再生成", flush=True)
    print("=" * 80, flush=True)
    print("改善内容:", flush=True)
    print("  1. 会場特性による補正（戸田0.95、がまかつ1.05など）", flush=True)
    print("  2. 信頼度判定基準の緩和（B: 70→65点）", flush=True)
    print("=" * 80, flush=True)
