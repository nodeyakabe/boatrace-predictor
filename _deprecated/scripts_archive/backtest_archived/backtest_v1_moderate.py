# -*- coding: utf-8 -*-
"""
v1.0 MODERATE戦略 バックテスト (baseline)
...
def main():
    print("=" * 70)
    print("v1.0 MODERATE戦略 バックテスト (baseline)")
    print("=" * 70)
    ...
    print_results(results, "v1.0 baseline 結果 (2025年11月)")
    ...
    if test_data_jan:
        ...
        print_results(results_jan, "v1.0 baseline 結果 (2025年1月)")
    ...
    if test_data_oct:
        ...
        print_results(results_oct, "v1.0 baseline 結果 (2025年10月)")
