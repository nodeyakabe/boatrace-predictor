...
# 性別判定設定
# ==============================================================================
# is_ladies=1 レースへの最低出場回数。これ以上出場した選手を female と判定する。
# (ladies_master.csv が利用できない場合のフォールバック)
# 変更時は backfill_is_ladies_v2.py と import_racers_csv.py の両方に自動適用される。
GENDER_LADIES_THRESHOLD = 50
